...
Features that inherently need a network — accounts, cloud save, live
...
- **Nothing is uploaded implicitly.** Saving to the cloud and sharing a review
  link are explicit, opt-in actions.
...
holds them hostage: every model can leave as an open file, and nothing leaves
your browser unless you send it.
